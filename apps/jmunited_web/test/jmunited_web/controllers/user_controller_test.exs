defmodule JmunitedWeb.UserControllerTest do
  use JmunitedWeb.ConnCase

  alias Jmunited.UserContext

  @create_attrs %{city: "some city", country: "some country", email: "some email", first_name: "some first_name", last_name: "some last_name", number: 42, street: "some street", zip: 42}
